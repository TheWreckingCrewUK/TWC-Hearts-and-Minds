...
*/
private _weapons = ["CUP_arifle_M4A1_ACOG_Laser",
	"CUP_launch_M136"
	];
private _magazines = ["30Rnd_556x45_Stanag_red",
"30Rnd_556x45_Stanag",
...
private _radio = ["ACRE_PRC148"] select (isClass(configFile >> "cfgPatches" >> "acre_main"));
...
private _weapons = ["CUP_arifle_M4A1_Black", "arifle_MXC_khk_F", "arifle_MXC_Black_F", "arifle_MXC_Black_F"];
